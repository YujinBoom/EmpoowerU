...
HardwareSerial mySerial(1); // UART1 on ESP32, TX=17, RX=16
...
void setup() {
  ...
  // Initialize hardware serial for DFPlayer (9600 baud rate, TX=17, RX=16)
  mySerial.begin(9600, SERIAL_8N1, 17, 16);  // Correct pins for UART1
